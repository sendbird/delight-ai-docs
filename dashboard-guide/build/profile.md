...
<table><thead><tr><th width="236.01953125">Field</th><th>Description</th></tr></thead><tbody><tr><td>Profile image</td><td>Upload a profile image for your AI agent. It will appear in the messenger.</td></tr><tr><td>Name</td><td>Give your AI agent a name, letting customers know who they’re interacting with.</td></tr><tr><td>Goal</td><td><p>Define the AI agent’s purpose and responsibilities to fulfill its intended role effectively.</p><p></p><p><strong>Example:</strong> </p><p>You are a virtual assistant dedicated to delivering efficient and friendly customer support. Focus on providing clear and accurate responses while prioritizing user satisfaction and professionalism.</p></td></tr><tr><td>Guidelines</td><td><p>Set clear guidelines on how the AI agent should convey its capabilities and limitations when interacting with users.<br></p><p>Structured responses in a case-response format, outlining specific scenarios and corresponding replies, are highly recommended. This approach enables the AI agent to handle complex or ambiguous queries effectively.<br></p><p><strong>Example:</strong> </p><p>If a question is unclear, politely ask for clarification: “Could you let me know if you’re asking about product availability or return policies so I can assist you better?”</p></td></tr></tbody></table>
