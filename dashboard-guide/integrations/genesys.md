...
Enhance customer support through advanced AI communication tools - Delight AI agent's [Voice channel](../build/channels/voice.md). Integrating the AI agent with your Genesys account can significantly improve your voice chat capabilities, offering a seamless and efficient customer communication experience.&#x20;
...
This guide presumes that you have already registered a phone number in Genesys via which Delight AI agent to hand over its calls to human agents. Follow the instructions below for seamless integration for the **Voice** channel.

1. In Delight AI dashboard, go to **Build > Channels** and click on the **Voice** channel tile.&#x20;
...
<figure><img src="../../.gitbook/assets/스크린샷 2025-09-16 오전 11.15.43.png" alt=""><figcaption></figcaption></figure>
