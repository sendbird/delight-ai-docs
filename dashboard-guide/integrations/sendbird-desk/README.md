...
{% hint style="info" %}
Self-serve integration is currently not supported. Contact a Sendbird representative to connect Sendbird Desk with the AI agent.
{% endhint %}
...
When an AI agent hands off a conversation, it invites a human agent to the channel, shares a brief summary of the interaction, and exits. To let the human agent view previous messages, enable **Chat history** under **Settings > Chat > Channels** in your Desk dashboard.

<figure><img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXfOkY1Xh9a4x2Rqd-w3WzmH9_FSwZRpN03caGwEsSHFcYs6IP-q16TdRzibIbZ17GFcA1wakeJ4jfW21rvRUqFffQ365IgHL44WuhY1gM_q6DaWdJR4_jHF7C0wUQbg8aE80K4h?key=xS65XOd58rPJOYVnOh8lJEX0" alt=""><figcaption></figcaption></figure>
...
As of May 12, 2025, the integration can be established by Sendbird upon your request. Contact a Delight AI agent representative or [our Sales team](https://xn--zca.com/contact-sales) to connect Sendbird Desk with the AI agent.
...
<figure><img src="../../../.gitbook/assets/image (15) (1) (1).png" alt="" width="326"><figcaption><p>Connection status on Sendbird Desk dashbaord</p></figcaption></figure>
