...
{% hint style="info" %}
For more information, refer to the [Sendbird Docs](https://sendbird.com/docs/security/documentation/org-account/two-factor-authentication).
{% endhint %}
...
{% hint style="info" %}
For more information, refer to the [Sendbird Docs](https://sendbird.com/docs/security/documentation/org-account/single-sign-on).
{% endhint %}
...
{% hint style="info" %}
For more information, refer to the [Sendbird Docs](https://sendbird.com/docs/security/documentation/org-account/restrict-login-ip-addresses).
{% endhint %}
...
{% hint style="info" %}
For more information, refer to the [Sendbird Docs](https://sendbird.com/docs/security/documentation/org-account/enforce-access-control).
{% endhint %}
...
{% hint style="info" %}
For more information, refer to the [Roles and permissions](../dashboard-guide/roles-and-permissions.md).
{% endhint %}
